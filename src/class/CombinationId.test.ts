    ...
    describe("Converts full to short", (): void => {
        test.each([
            ...
            [
                "too-short",
                "aae6-ffcf984a7a76",
                "00000000-0000-0000-aae6-ffcf984a7a76",
                "00000000000eFHXYlBYpbo",
            ],
            [
                "too-long",
        ...
        ])("%s", (name: string, full: string, expectedFull: string, expectedShort: string): void => {
    ...
    describe("Converts short to full", (): void => {
        test.each([
            ...
            [
                ...
                "ZZZZZZZZZZZZZZZZZZZZZZ",
                "f520034c-4307-70c4-2452-8c66503fffff",
            ],
            [
                "too-short",
                "eFHXYlBYpbo",
        ...
        ])("%s", (name: string, short: string, expectedShort: string, expectedFull: string): void => {
