...
describe("PortalApi", (): void => {
    describe("endpoints", (): void => {
        ...
        beforeEach((): void => {
            ...
            jest.spyOn(window, "fetch").mockReturnValue(mockedResponse.clone());
            jest.spyOn(storageManager, "combinationId", "get").mockReturnValue(CombinationId.fromFull(combinationId));
        });
